    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-sm text-red-600 font-medium">* Required to save</span>
        </div>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 space-y-4">
          ...
          <LicenseFormField
            ...
            placeholder="e.g., 03-066-041605 (Nepal Format: XX-XXX-XXXXXX)"
            required
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-sm text-blue-600 font-medium">Optional - helps with verification</span>
        </div>
